...
// ACTIVE_WITHIN_DAYS. See doc/DESIGN.md.
type HotInboxRepository interface {
	...
	// any) is in the cold tier instead -- see doc/DESIGN.md.
...
// -- see doc/DESIGN.md for the RocksDB->BadgerDB substitution rationale.
...
// doc/DESIGN.md and doc/TRADE-OFFS.md for why a bounded-TTL ZSET
...
// service's perspective) view of the social graph. See doc/DESIGN.md
...
// which live in Redis (CounterRepository) per doc/DESIGN.md "Counters
...
// by post-ingestion-service. See doc/DESIGN.md.
...
// not the post. See doc/DESIGN.md.
