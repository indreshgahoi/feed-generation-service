...
| Doc | What's in it |
|---|---|
| [architecture.md](architecture.md) | Every service, what it owns, the sharded/graph/hot-cold data model, and how the 7 services + Envoy + infra pieces fit together |
...
| [gateway.md](gateway.md) | The Envoy gateway: the routing table, why 2 internal service-to-service calls deliberately bypass it, and the HTTP/3 (QUIC) listener scoped to the feed read path -- including how it was actually verified |
...
- **Want the deployment/gateway design specifically?** [gateway.md](gateway.md).
